...
set ProjectFolder ./ddr4_quad_channel
...
create_project ddr4_quad_channel ./ddr4_quad_channel -part xcvu9p-fsgd2104-2L-e
...
#set_property -dict [list CONFIG.C0_CLOCK_BOARD_INTERFACE {default_300mhz_clk1}] [get_bd_cells ddr4_1]
#set_property -dict [list CONFIG.C0_CLOCK_BOARD_INTERFACE {default_300mhz_clk2}] [get_bd_cells ddr4_2]
#set_property -dict [list CONFIG.C0_CLOCK_BOARD_INTERFACE {default_300mhz_clk3}] [get_bd_cells ddr4_3]
...
set_property -dict [list CONFIG.C0.DDR4_CustomParts [lindex [get_files */crutial_ballistix_sport_lt_4gb.csv] 0] CONFIG.C0.DDR4_isCustom {true}] [get_bd_cells ddr4_1]
set_property -dict [list CONFIG.C0.DDR4_CustomParts [lindex [get_files */crutial_ballistix_sport_lt_4gb.csv] 0] CONFIG.C0.DDR4_isCustom {true}] [get_bd_cells ddr4_2]
set_property -dict [list CONFIG.C0.DDR4_CustomParts [lindex [get_files */crutial_ballistix_sport_lt_4gb.csv] 0] CONFIG.C0.DDR4_isCustom {true}] [get_bd_cells ddr4_3]
...
set_property -dict [list CONFIG.C0.DDR4_MemoryType {UDIMMs} CONFIG.C0.DDR4_MemoryPart {BLS4G4D240FSB} CONFIG.C0.DDR4_DataWidth {64} CONFIG.C0.DDR4_CasLatency {16} CONFIG.C0.DDR4_CasWriteLatency {16} CONFIG.C0.DDR4_AxiDataWidth {512} CONFIG.C0.DDR4_AxiAddressWidth {32}] [get_bd_cells ddr4_1]
set_property -dict [list CONFIG.C0.DDR4_MemoryType {UDIMMs} CONFIG.C0.DDR4_MemoryPart {BLS4G4D240FSB} CONFIG.C0.DDR4_DataWidth {64} CONFIG.C0.DDR4_CasLatency {16} CONFIG.C0.DDR4_CasWriteLatency {16} CONFIG.C0.DDR4_AxiDataWidth {512} CONFIG.C0.DDR4_AxiAddressWidth {32}] [get_bd_cells ddr4_2]
set_property -dict [list CONFIG.C0.DDR4_MemoryType {UDIMMs} CONFIG.C0.DDR4_MemoryPart {BLS4G4D240FSB} CONFIG.C0.DDR4_DataWidth {64} CONFIG.C0.DDR4_CasLatency {16} CONFIG.C0.DDR4_CasWriteLatency {16} CONFIG.C0.DDR4_AxiDataWidth {512} CONFIG.C0.DDR4_AxiAddressWidth {32}] [get_bd_cells ddr4_3]
...
connect_bd_intf_net [get_bd_intf_pins axi_smc/M00_AXI] [get_bd_intf_pins ddr4_1/C0_DDR4_S_AXI]
connect_bd_intf_net [get_bd_intf_pins axi_smc/M01_AXI] [get_bd_intf_pins ddr4_0/C0_DDR4_S_AXI]
...
set_property name default_300mhz_clk1 [get_bd_intf_ports C0_SYS_CLK_1]
set_property name default_300mhz_clk2 [get_bd_intf_ports C0_SYS_CLK_2]
set_property name default_300mhz_clk3 [get_bd_intf_ports C0_SYS_CLK_3]

set_property CONFIG.FREQ_HZ 300000000 [get_bd_intf_ports /default_300mhz_clk0]
set_property CONFIG.FREQ_HZ 300000000 [get_bd_intf_ports /default_300mhz_clk1]
set_property CONFIG.FREQ_HZ 300000000 [get_bd_intf_ports /default_300mhz_clk2]
set_property CONFIG.FREQ_HZ 300000000 [get_bd_intf_ports /default_300mhz_clk3]
endgroup

assign_bd_address

add_files -fileset constrs_1 -norecurse ./bcu1525_ballistix_ddr4_c0.xdc
add_files -fileset constrs_1 -norecurse ./bcu1525_ballistix_ddr4_c1.xdc
add_files -fileset constrs_1 -norecurse ./bcu1525_ballistix_ddr4_c2.xdc
add_files -fileset constrs_1 -norecurse ./bcu1525_ballistix_ddr4_c3.xdc

import_files -fileset constrs_1 ./bcu1525_ballistix_ddr4_c0.xdc
import_files -fileset constrs_1 ./bcu1525_ballistix_ddr4_c1.xdc
import_files -fileset constrs_1 ./bcu1525_ballistix_ddr4_c2.xdc
import_files -fileset constrs_1 ./bcu1525_ballistix_ddr4_c3.xdc

make_wrapper -files [get_files ./ddr4_quad_channel/ddr4_quad_channel.srcs/sources_1/bd/design_1/design_1.bd] -top
add_files -norecurse ./ddr4_quad_channel/ddr4_quad_channel.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v
