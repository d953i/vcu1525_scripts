...
set ProjectFolder ./vcu1525_quad_channel_ddr4
...
create_project vcu1525_quad_channel_ddr4 ./vcu1525_quad_channel_ddr4 -part xcvu9p-fsgd2104-2L-e
...
set_property -dict [list CONFIG.C0.DDR4_MemoryType {UDIMMs} CONFIG.C0.DDR4_MemoryPart {BLS4G4D240FSB} CONFIG.C0.DDR4_DataWidth {64} CONFIG.C0.DDR4_CasLatency {16} CONFIG.C0.DDR4_CasWriteLatency {16} CONFIG.C0.DDR4_AxiDataWidth {512} CONFIG.C0.DDR4_AxiAddressWidth {32} CONFIG.C0.DDR4_CustomParts {./crutial_ballistix_sport_lt_4gb.csv} CONFIG.C0.DDR4_isCustom {true}] [get_bd_cells ddr4_0]
set_property -dict [list CONFIG.C0.DDR4_MemoryType {UDIMMs} CONFIG.C0.DDR4_MemoryPart {BLS4G4D240FSB} CONFIG.C0.DDR4_DataWidth {64} CONFIG.C0.DDR4_CasLatency {16} CONFIG.C0.DDR4_CasWriteLatency {16} CONFIG.C0.DDR4_AxiDataWidth {512} CONFIG.C0.DDR4_AxiAddressWidth {32} CONFIG.C0.DDR4_CustomParts {./crutial_ballistix_sport_lt_4gb.csv} CONFIG.C0.DDR4_isCustom {true}] [get_bd_cells ddr4_1]
set_property -dict [list CONFIG.C0.DDR4_MemoryType {UDIMMs} CONFIG.C0.DDR4_MemoryPart {BLS4G4D240FSB} CONFIG.C0.DDR4_DataWidth {64} CONFIG.C0.DDR4_CasLatency {16} CONFIG.C0.DDR4_CasWriteLatency {16} CONFIG.C0.DDR4_AxiDataWidth {512} CONFIG.C0.DDR4_AxiAddressWidth {32} CONFIG.C0.DDR4_CustomParts {./crutial_ballistix_sport_lt_4gb.csv} CONFIG.C0.DDR4_isCustom {true}] [get_bd_cells ddr4_2]
...
add_files -fileset constrs_1 -norecurse ./vcu1525_ballistix_ddr4_c1.xdc
add_files -fileset constrs_1 -norecurse ./vcu1525_ballistix_ddr4_c2.xdc
add_files -fileset constrs_1 -norecurse ./vcu1525_ballistix_ddr4_c3.xdc

import_files -fileset constrs_1 ./vcu1525_ballistix_ddr4_c0.xdc
import_files -fileset constrs_1 ./vcu1525_ballistix_ddr4_c1.xdc
import_files -fileset constrs_1 ./vcu1525_ballistix_ddr4_c2.xdc
import_files -fileset constrs_1 ./vcu1525_ballistix_ddr4_c3.xdc

make_wrapper -files [get_files ./vcu1525_quad_channel_ddr4/vcu1525_quad_channel_ddr4.srcs/sources_1/bd/design_1/design_1.bd] -top
add_files -norecurse ./vcu1525_quad_channel_ddr4/vcu1525_quad_channel_ddr4.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v
